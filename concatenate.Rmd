...
setwd("raw1") #this is the folder name that contains the individual csvs
...
```{r save_csv}
write.csv(data,"inst-cat-uc.csv", row.names=FALSE) #save the large data frame as its own csv file
```
